<template>
    <button class="btn relative h-[4.8rem] flex items-center inter font-medium text-16 leading-none tracking-[-0.64px]" :class="`is-${color}`">
        <span class="btn-text flex items-center justify-center h-full px-40 rounded-[2.4rem] border-[0.2rem] border-solid">{{ label }}</span>
