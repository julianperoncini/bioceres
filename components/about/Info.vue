    ...
    <div class="relative">
        <div class="relative py-100 s:py-160 overflow-hidden">
            <div class="relative px-20 s:px-240">
                ...
                <div class="relative pb-50 s:pb-100 flex flex-col s:flex-row-reverse items-center justify-between">
                    <div class="relative pb-30 s:pb-0 max-w-full s:max-w-[50rem] w-full js-s-fade">
                        <p class="inter font-normal relative s:pr-70 text-[#25284A] text-18 leading-[1.35] tracking-[-0.72px]">
                            Los primeros proyectos de Bioceres se enfocaron en la biotecnología aplicada a la mejora de cultivos. En conjunto con el equipo liderado por la Dra. Raquel Chan del CONICET y un grupo de investigadores de la UNL, <strong class="font-bold">Bioceres desarrolló la tecnología HB4</strong>, que es la única tecnología del mundo que a través de un proceso de transgénesis; transferencia de un gen del girasol (hahb-4) al trigo y soja, aporta tolerancia a la sequía a los cultivos en situaciones de estrés hídrico.
                        </p>
                        <p class="inter font-semibold relative py-20 text-[#3FADE1] text-18 leading-[1.2] tracking-[-0.72px]">Es un desarrollo 100% argentino.</p>

                        <button class="uline relative flex items-center text-[#A0C344] font-regular inter text-18 leading-[1.2] tracking-[-0.72px]" type="button">
                            <span class="inline-block">
                                Conocé Bioceres Crops Solutions
                            </span>
                            <span class="inline-block ml-5">
                                <svg class="w-[1.8rem] h-auto rotate-[135deg]" viewBox="0 0 18 13" fill="none" xmlns="http://www.w3.org/2000/svg">
